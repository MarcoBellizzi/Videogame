...
public class Ananke : MonoBehaviour
{
public enum ThaeliaState
    ...
    private void Talk1()
    {
        ...
        PanelDialogues.instance.Show("ananke_1");
    }
    ...
    public void Talk2()
    {
        ...
        Player.instance.canMove = false;
        animator.SetTrigger("talk");
        PanelDialogues.instance.Show("ananke_2");
    }
    ...
    public void GetSpada()
    {
        Bag.instance.AddItem("Spada", "Aumenta il tuo attacco del 15%");
        PanelObjects.instance.Show("Spada", "Aumenta il tuo attacco del 15%");
        Idle();
    }

    public void AskQuestion()
    {
        PanelChoice.instance.Show("question_ananke");
    }
}
